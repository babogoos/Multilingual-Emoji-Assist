    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 md:p-10 lg:p-16 bg-background font-body">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <footer className="text-center text-sm text-muted-foreground pt-8 tabular-nums space-y-1">
          <p>{footerText}</p>
          <p>
            Developed by <a href="https://linktr.ee/dion.chang" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Dion Chang</a>
          </p>
          <p>For any questions or feedback, feel free to <a href="https://linktr.ee/dion.chang" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">reach out</a>.</p>
        </footer>
      </div>
    </main>
  );
